...
if (!function_exists('mb_strtoupper')) {
    die('Termux manager<br>Error: Please enable "mbstring" php module.');
}
// +--------------------------------------------------
// | Config Class
// +--------------------------------------------------
...
// +--------------------------------------------------
// | BASE64 FILES
// | So that Termux manager can remain a single file script,
...
function portscan_form(){
    ...
    <!--
        ...
        write_to_iframe(get_boxed_text('Termux manager - Portscan<br><br><b>Hosts examples:</b><br>Single: phpfm.sf.net<br>Single: 192.168.0.1<br>Range: 192.168.0.1-254<br>Multiple: phpfm.sf.net,192.168.0.1,192.168.0.2'));
        ...
        function execute_portscan(){
            ...
            portscan_command_str += 'Termux manager - Portscan<br><br>';
